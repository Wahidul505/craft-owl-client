...
const EditProfile = ({ user, userInfo, refetch, setShowEdit }) => {
  ...
  const handleUpdateUser = (e) => {
    ...
    fetch(`https://craft-owl-server.vercel.app/update-user/${user?.email}`, {
      method: "PATCH",
      headers: {
  ...
  return (
    <div>
      <form className="w-full flex flex-col gap-4" onSubmit={handleUpdateUser}>
        ...
        <div className="form-control">
          <label className="input-group">
            ...
            <input
              type="text"
              name="education"
              placeholder="Institute/ year/ lastDegree"
              className="input input-bordered w-full"
              required
