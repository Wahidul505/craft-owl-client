            ...
            <div class="hero">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <p class="py-6 text-xl">Welcome to Our Manufacturing website. We encourage you to visit our site and be a part of us. Here we will supply you the products that you ordered with the fastest delivery service. Happy visiting!</p>
